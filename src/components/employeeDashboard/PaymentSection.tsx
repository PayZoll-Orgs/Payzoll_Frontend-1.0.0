...
export default function PaymentSection({ employeeHistoryInfo, employeeInfo }: {
  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 hover:border-indigo-500/50 transition-all h-full">
          ...
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-800">
              {employeeHistoryInfo.map((history, index) => (
                <tr key={index} className="group hover:bg-gray-900/30 transition-colors">
