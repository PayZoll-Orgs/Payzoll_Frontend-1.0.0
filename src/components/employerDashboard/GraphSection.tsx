      ...
      <div className="h-[350px] transition-all hover:opacity-95">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
            ...
            <Line type="monotone" dataKey="Engineering" stroke="#6366f1" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 8, className: "animate-pulse" }} />
            <Line type="monotone" dataKey="Marketing" stroke="#8b5cf6" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 8, className: "animate-pulse" }} />
            <Line type="monotone" dataKey="Sales" stroke="#a855f7" strokeWidth={2} dot={{ r: 4 }} activeDot={{ r: 8, className: "animate-pulse" }} />
          </LineChart>
        </ResponsiveContainer>
      </div>
    </div>
