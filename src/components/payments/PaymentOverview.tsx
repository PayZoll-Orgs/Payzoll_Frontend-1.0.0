...
import { DollarSign, Users, Grid3X3 } from "lucide-react";
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="h-auto min-h-[180px] sm:min-h-[200px] lg:min-h-[220px] bg-[#14161E] border border-[#3B4058]/30 rounded-xl p-4 sm:p-5 lg:p-6 hover:border-[#93c5fd]/40 transition-all group"
          >
            <div className="flex items-center justify-between mb-4 sm:mb-5 lg:mb-6">
              <div>
                <h3 className="text-[#c8ceee] font-mono text-lg sm:text-xl mb-1 sm:mb-2">{card.title}</h3>
            ...
            <button 
              ...
              className="w-full mt-4 sm:mt-5 lg:mt-6 bg-gradient-to-r from-[#3B4058] to-[#93c5fd] text-white 
